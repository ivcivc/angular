...
.dx-scheduler-appointment.dx-resizable-resizing {
  ...
  -moz-box-shadow: inset 0px -2px 0px 0px rgba(0, 0, 0, 0.5), inset 0px 2px 0px 0px rgba(0, 0, 0, 0.5);
...
.dx-scheduler-appointment.dx-state-hover {
  ...
  -moz-box-shadow: inset 0px 5px 0px 0px rgba(0, 0, 0, 0.5);
...
.dx-scheduler-appointment.dx-state-hover.dx-resizable {
  ...
  -moz-box-shadow: inset 0px 5px 0px 0px rgba(0, 0, 0, 0.5), inset 0px -2px 0px 0px rgba(0, 0, 0, 0.5);
...
.dx-scheduler-appointment.dx-draggable-dragging {
  ...
  -moz-box-shadow: 7px 7px 15px 0px rgba(50, 50, 50, 0.2), inset 0px -2px 0px 0px rgba(0, 0, 0, 0.5), inset 0px 2px 0px 0px rgba(0, 0, 0, 0.5);
...
.dx-scheduler-all-day-appointment {
  ...
  -moz-box-shadow: inset 2px 0px 0px 0px rgba(0, 0, 0, 0.5);
...
.dx-scheduler-all-day-appointment.dx-resizable-resizing {
  ...
  -moz-box-shadow: inset -2px 0px 0px 0px rgba(0, 0, 0, 0.5), inset 2px 0px 0px 0px rgba(0, 0, 0, 0.5);
...
.dx-scheduler-all-day-appointment.dx-state-hover {
  ...
  -moz-box-shadow: inset 5px 0px 0px 0px rgba(0, 0, 0, 0.5);
...
.dx-scheduler-all-day-appointment.dx-state-hover.dx-resizable {
  ...
  -moz-box-shadow: inset 5px 0px 0px 0px rgba(0, 0, 0, 0.5), inset -2px 0px 0px 0px rgba(0, 0, 0, 0.5);
...
.dx-scheduler-all-day-appointment.dx-draggable-dragging {
  ...
  -moz-box-shadow: inset -2px 0px 0px 0px rgba(0, 0, 0, 0.5), inset 2px 0px 0px 0px rgba(0, 0, 0, 0.5), 7px 7px 15px 0px rgba(50, 50, 50, 0.2);
...
.dx-show-clear-button .dx-texteditor .dx-texteditor-input {
  padding-right: 38px;
}
.dx-rtl.dx-show-clear-button .dx-texteditor .dx-texteditor-input,
.dx-rtl .dx-show-clear-button .dx-texteditor .dx-texteditor-input {
  padding-right: 10px;
  padding-left: 38px;
}
...
.dx-loadindicator-segment {
  ...
  -moz-animation: dx-win-loadindicator-orbit 5s infinite;
...
.dx-state-hover.dx-radiobutton-checked .dx-radiobutton-icon,
.dx-state-focused.dx-radiobutton-checked .dx-radiobutton-icon {
  border-color: #0078d7;
}
.dx-state-hover.dx-radiobutton-checked .dx-radiobutton-icon-dot,
.dx-state-focused.dx-radiobutton-checked .dx-radiobutton-icon-dot {
  background-color: #ffffff;
}
