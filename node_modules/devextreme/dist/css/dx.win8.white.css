...
.dx-tabs.dx-navbar .dx-icon {
  ...
  height: 40px;
  background-position: 6px 6px;
  -webkit-background-size: 22.4px 22.4px;
  -moz-background-size: 22.4px 22.4px;
...
.dx-popup-title + .dx-popup-content.dx-lookup-invalid {
  padding-top: 30px;
}
...
.dx-loadindicator-segment {
  ...
  -moz-animation: dx-win-loadindicator-orbit 4.95s infinite;
  -o-animation: dx-win-loadindicator-orbit 4.95s infinite;
...
.dx-state-focused.dx-radiobutton .dx-radiobutton-icon:before {
  ...
  -moz-box-shadow: inset #9c9c9c 0 0 3px;
...
.dx-datagrid .dx-menu-items-container .dx-menu-item-has-icon.dx-state-focused .dx-icon-filter-operation-between {
  background-image: url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAwAAAAFCAQAAADbc8WkAAAAHElEQVQYV2NI+J/A8B8DJoAQbgmsEKwDC8QtAQC2WDWbJkSICQAAAABJRU5ErkJggg==);
}
