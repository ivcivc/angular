...
.dx-dateview-item-selected-frame:before {
  ...
  border-bottom: 1px solid #fff;
  background-repeat: no-repeat;
  background-image: -webkit-linear-gradient(bottom, rgba(0, 0, 0, 0) 0%, rgba(0, 0, 0, 0.8) 60%);
  background-image: -moz-linear-gradient(bottom, rgba(0, 0, 0, 0) 0%, rgba(0, 0, 0, 0.8) 60%);
  background-image: -ms-linear-gradient(bottom, rgba(0, 0, 0, 0) 0%, rgba(0, 0, 0, 0.8) 60%);
  background-image: -o-linear-gradient(bottom, rgba(0, 0, 0, 0) 0%, rgba(0, 0, 0, 0.8) 60%);
}
.dx-dateview-item-selected-frame:after {
  top: 34px;
  border-top: 1px solid #fff;
  ...
  background-image: -moz-linear-gradient(top, rgba(0, 0, 0, 0) 0%, rgba(0, 0, 0, 0.8) 60%);
  background-image: -ms-linear-gradient(top, rgba(0, 0, 0, 0) 0%, rgba(0, 0, 0, 0.8) 60%);
  background-image: -o-linear-gradient(top, rgba(0, 0, 0, 0) 0%, rgba(0, 0, 0, 0.8) 60%);
}
.dx-toolbar {
  background-color: #000;
  color: #fff;
...
.dx-progressbar-animating-container {
  ...
  background-repeat: no-repeat;
  background-image: -webkit-linear-gradient(left, transparent 5%, #cf00d7, transparent 95%);
  background-image: -moz-linear-gradient(left, transparent 5%, #cf00d7, transparent 95%);
  background-image: -ms-linear-gradient(left, transparent 5%, #cf00d7, transparent 95%);
  background-image: -o-linear-gradient(left, transparent 5%, #cf00d7, transparent 95%);
