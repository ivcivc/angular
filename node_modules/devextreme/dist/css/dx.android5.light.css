...
.dx-button.dx-state-active {
  ...
  -moz-box-shadow: 0 4px 13px 0 rgba(0, 0, 0, 0.3), 0 2px 2px 0 rgba(0, 0, 0, 0.2);
...
.dx-checkbox-icon {
  ...
  border-radius: 2px;
  background-color: transparent;
  -webkit-transition: background-color .14s linear, border-color .14s linear;
  -moz-transition: background-color .14s linear, border-color .14s linear;
  -o-transition: background-color .14s linear, border-color .14s linear;
...
.dx-checkbox-indeterminate .dx-checkbox-icon {
  ...
  -moz-box-shadow: inset 0px 0px 0px 2px #00BCD4;
...
.dx-tab-selected {
  ...
  -moz-box-shadow: inset 0px -3px 0px #FFFF8D;
...
.dx-texteditor.dx-invalid.dx-state-focused .dx-texteditor-container:before {
  ...
  -moz-transition: -moz-transform 0.3s cubic-bezier(0.2, 0, 0.03, 1);
  -o-transition: -o-transform 0.3s cubic-bezier(0.2, 0, 0.03, 1);
...
.dx-rtl .dx-dropdowneditor.dx-dropdowneditor-button-visible.dx-invaild .dx-texteditor-input,
.dx-rtl.dx-dropdowneditor.dx-dropdowneditor-button-visible.dx-invaild .dx-texteditor-input {
  padding-left: 50px;
  padding-right: 0;
}
.dx-rtl .dx-dropdowneditor.dx-dropdowneditor-button-visible.dx-invalid.dx-show-clear-button .dx-texteditor-input,
.dx-rtl.dx-dropdowneditor.dx-dropdowneditor-button-visible.dx-invalid.dx-show-clear-button .dx-texteditor-input {
  padding-left: 94px;
  padding-right: 0;
}
.dx-rtl .dx-dropdowneditor.dx-dropdowneditor-button-visible.dx-show-clear-button .dx-texteditor-input,
.dx-rtl.dx-dropdowneditor.dx-dropdowneditor-button-visible.dx-show-clear-button .dx-texteditor-input {
  padding-left: 64px;
  padding-right: 0;
}
.dx-rtl .dx-dropdowneditor .dx-dropdowneditor-icon,
.dx-rtl.dx-dropdowneditor .dx-dropdowneditor-icon {
...
.dx-popup-wrapper > .dx-overlay-content {
  ...
  -moz-box-shadow: 0 7px 40px 0 rgba(0, 0, 0, 0.3), 0 14px 12px 0 rgba(0, 0, 0, 0.17);
...
.dx-popover-wrapper .dx-overlay-content {
  ...
  -moz-box-shadow: 0 3px 25px 0 rgba(0, 0, 0, 0.3), 0 11px 7px 0 rgba(0, 0, 0, 0.19);
...
.dx-progressbar-animating-segment {
  ...
  -moz-animation-timing-function: cubic-bezier(0.3, 1, 0.15, 0.8);
  -o-animation-timing-function: cubic-bezier(0.3, 1, 0.15, 0.8);
...
.dx-popup-title + .dx-popup-content .dx-lookup-validation-message {
  margin-top: 10px;
}
...
.dx-popup-title + .dx-popup-content.dx-lookup-invalid .dx-list {
  top: 60px;
}
...
.dx-radiobutton-icon {
  ...
  -moz-transition: border-color .14s;
  -o-transition: border-color .14s;
...
.dx-datagrid .dx-menu-base .dx-menu-item .dx-menu-item-content {
  padding: 8px 0px 0px 9px;
}
.dx-datagrid .dx-menu-base .dx-menu-item .dx-menu-item-content .dx-icon {
  margin-right: 9px;
  min-width: 16px;
  height: 16px;
}
...
.dx-calendar-view-month .dx-calendar-cell.dx-state-active:not(.dx-calendar-empty-cell) {
  background: #ececec;
  background: -webkit-radial-gradient(circle closest-side, #ececec 90%, rgba(255, 255, 255, 0) 95%);
  background: -moz-radial-gradient(circle closest-side, #ececec 90%, rgba(255, 255, 255, 0) 95%);
  background: -ms-radial-gradient(circle closest-side, #ececec 90%, rgba(255, 255, 255, 0) 95%);
  background: -o-radial-gradient(circle closest-side, #ececec 90%, rgba(255, 255, 255, 0) 95%);
...
.dx-calendar-view-month .dx-calendar-cell.dx-calendar-selected-date.dx-state-active {
  color: #fff;
  background: #00BCD4;
  background: -webkit-radial-gradient(circle closest-side, #00BCD4 90%, rgba(255, 255, 255, 0) 95%);
  background: -moz-radial-gradient(circle closest-side, #00BCD4 90%, rgba(255, 255, 255, 0) 95%);
  background: -ms-radial-gradient(circle closest-side, #00BCD4 90%, rgba(255, 255, 255, 0) 95%);
  background: -o-radial-gradient(circle closest-side, #00BCD4 90%, rgba(255, 255, 255, 0) 95%);
...
.dx-calendar-view-month td.dx-calendar-contoured-date {
  background: transparent;
  background: -webkit-radial-gradient(circle closest-side, transparent 90%, #d7d7d7 95%, transparent 100%);
  background: -moz-radial-gradient(circle closest-side, transparent 90%, #d7d7d7 95%, transparent 100%);
  background: -ms-radial-gradient(circle closest-side, transparent 90%, #d7d7d7 95%, transparent 100%);
  background: -o-radial-gradient(circle closest-side, transparent 90%, #d7d7d7 95%, transparent 100%);
