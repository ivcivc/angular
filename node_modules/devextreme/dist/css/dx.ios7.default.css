...
@font-face {
  font-family: 'DXIcons';
  src: url(icons/dxiconsios.eot);
  src: url(icons/dxiconsios.eot) format('embedded-opentype'), url(icons/dxiconsios.woff) format('woff'), url(icons/dxiconsios.ttf) format('truetype');
  font-weight: normal;
  font-style: normal;
}
.dx-icon {
...
.dx-invalid.dx-dropdowneditor .dx-texteditor-input {
  padding-right: 58px;
}
...
.dx-rtl.dx-dropdowneditor-button-visible.dx-invalid .dx-texteditor-input {
  padding-left: 58px;
  padding-right: 6px;
}
.dx-rtl.dx-dropdowneditor-button-visible.dx-invalid.dx-show-clear-button .dx-texteditor-input {
  padding-left: 92px;
  padding-right: 6px;
}
...
.dx-dateview-item-selected-frame:before {
  top: -74px;
  background-repeat: no-repeat;
  background-image: -webkit-linear-gradient(bottom, rgba(255, 255, 255, 0) 0%, rgba(255, 255, 255, 0.8) 80%);
  background-image: -moz-linear-gradient(bottom, rgba(255, 255, 255, 0) 0%, rgba(255, 255, 255, 0.8) 80%);
  background-image: -ms-linear-gradient(bottom, rgba(255, 255, 255, 0) 0%, rgba(255, 255, 255, 0.8) 80%);
  background-image: -o-linear-gradient(bottom, rgba(255, 255, 255, 0) 0%, rgba(255, 255, 255, 0.8) 80%);
}
.dx-dateview-item-selected-frame:after {
  top: 34px;
  background-repeat: no-repeat;
...
.dx-progressbar-animating-container {
  ...
  background-repeat: no-repeat;
  background-image: -webkit-linear-gradient(left, transparent 5%, #74b9ff, transparent 95%);
  background-image: -moz-linear-gradient(left, transparent 5%, #74b9ff, transparent 95%);
  background-image: -ms-linear-gradient(left, transparent 5%, #74b9ff, transparent 95%);
  background-image: -o-linear-gradient(left, transparent 5%, #74b9ff, transparent 95%);
...
.dx-state-disabled .dx-progressbar-animating-container {
  ...
  animation: none;
  background-repeat: no-repeat;
  background-image: -webkit-linear-gradient(left, transparent 5%, #b7b6bb, transparent 95%);
  background-image: -moz-linear-gradient(left, transparent 5%, #b7b6bb, transparent 95%);
  background-image: -ms-linear-gradient(left, transparent 5%, #b7b6bb, transparent 95%);
  background-image: -o-linear-gradient(left, transparent 5%, #b7b6bb, transparent 95%);
  background-repeat: repeat;
  background-color: #d8d8d8;
...
.dx-rtl .dx-lookup-popup-wrapper .dx-list-item-selected .dx-list-item-content:before,
.dx-rtl.dx-lookup-popup-wrapper .dx-list-item-selected .dx-list-item-content:before {
  float: left;
  margin-left: 20px;
}
.dx-rtl .dx-lookup-popup-wrapper .dx-list-item-selected .dx-list-item-content {
  padding-right: 15px;
  padding-left: 20px;
}
...
.dx-datagrid-column-chooser.dx-datagrid-column-chooser-mode-select .dx-overlay-content .dx-toolbar {
  margin-bottom: 9px;
}
...
.dx-datagrid-rowsview .dx-item-modified {
  outline: 2px solid rgba(90, 200, 250, 0.7);
}
