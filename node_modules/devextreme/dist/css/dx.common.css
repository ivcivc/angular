...
.dx-datagrid .dx-column-indicators .dx-sort.dx-sort-none,
.dx-datagrid .dx-column-indicators .dx-header-filter.dx-sort-none {
  width: 14px;
}
...
.dx-datagrid-content .dx-datagrid-table .dx-row .dx-datagrid-invalid {
  padding: 0;
}
...
.dx-datagrid-rowsview .dx-hidden-column-nowrap {
  white-space: nowrap;
}
