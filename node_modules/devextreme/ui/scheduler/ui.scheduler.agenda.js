        ...
        var fillTableBody = $.proxy(function(rowIndex, rowSize) {
            if (rowSize) {
                ...
                if (options.getStartDate) {
                    ...
                    cellDayName = dateLocalization.format(date, "E")
                }
                if (options.cellTemplate && options.cellTemplate.render) {
                    var groupsOpt = this.option("groups"),
                        groups = {},
                        path = groupsOpt.length && this._getPathToLeaf(i) || [];
                    ...
                    options.cellTemplate.render(templateOptions)
                } else {
