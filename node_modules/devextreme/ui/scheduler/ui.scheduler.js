...
var $ = require("jquery"),
    ...
    EmptyTemplate = require("../widget/ui.template.empty"),
...
var Scheduler = Widget.inherit({
    ...
    _optionChanged: function(args) {
        ...
        switch (args.name) {
            ...
            case "timeZone":
                this._calculateTimezoneByOption();
                this.repaint();
                break;
            case "startDateExpr":
            case "endDateExpr":
    ...
    _getTimezoneOffsetByOption: function() {
        return this._timezone
    },
    _calculateTimezoneByOption: function() {
        this._timezone = this._calculateTimezoneByValue(this.option("timeZone"))
    },
    _calculateTimezoneByValue: function(timezone) {
        var result = timezone;
    ...
    _initTemplates: function() {
        ...
        this._defaultTemplates.item = new BindableTemplate(function($container, data) {
            ...
            if (data.startDate) {
                $("<div>").text(dateLocalization.format(dateUtils.makeDate(data.startDate), "shorttime")).addClass("dx-scheduler-appointment-content-date").appendTo($details)
            }
            if (data.endDate) {
                $("<div>").text(" - ").addClass("dx-scheduler-appointment-content-date").appendTo($details);
                $("<div>").text(dateLocalization.format(dateUtils.makeDate(data.endDate), "shorttime")).addClass("dx-scheduler-appointment-content-date").appendTo($details)
            }
            $details.appendTo($container);
            if (data.recurrenceRule) {
                $("<span>").addClass("dx-scheduler-appointment-recurrence-icon dx-icon-repeat").appendTo($container)
            }
        }, ["text", "html", "allDay", "startDate", "endDate", "recurrenceRule"], this);
    ...
    _initDynamicPopupTemplate: function(appointmentData, processTimeZone) {
        var that = this;
        this._defaultTemplates.appointmentPopup = new FunctionTemplate(function(data, index, $container) {
