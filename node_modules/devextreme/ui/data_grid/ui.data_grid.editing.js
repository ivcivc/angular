...
exports.EditingController = gridCore.ViewController.inherit(function() {
    ...
    return {
        ...
        getFormEditorTemplate: function(detailCellOptions, column, item, isReadOnly) {
            var that = this;
            return function(options, $container) {
                ...
                that._rowsView.renderTemplate($container, template, cellOptions)
            }
        },
        ...
        views: {
            rowsView: {
                ...
                _updateCell: function($cell, parameters) {
                    if ("detail" === parameters.rowType && parameters.item) {
