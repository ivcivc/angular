...
exports.DataController = gridCore.Controller.inherit({}).include(DataHelperMixin).inherit(function() {
    var members = {
        ...
        publicMethods: function() {
            return ["beginCustomLoading", "endCustomLoading", "refresh", "filter", "clearFilter", "getCombinedFilter", "keyOf", "byKey", "getDataByKeys", "pageIndex", "pageSize", "pageCount", "totalCount", "_disposeDataSource", "getKeyByRowIndex", "getRowIndexByKey", "getDataSource"]
        },
                ...
                switch (changeType) {
                    ...
                    case "update":
                        ...
                        var equalItems = function(item1, item2, strict) {
                            return item1 && item2 && gridCoreUtils.equalKeys(item1.key, item2.key) && (!strict || item1.rowType === item2.rowType)
                        };
