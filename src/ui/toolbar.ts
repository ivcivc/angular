...
export class DxToolbarComponent extends DxComponent implements OnChanges, DoCheck {
    instance: DxToolbar;
    ...
    @Output() renderAsChange: EventEmitter<any>;
    ...
    constructor(elementRef: ElementRef, ngZone: NgZone, templateHost: DxTemplateHost, private _watcherHelper: WatcherHelper,
        ...
        this.renderAsChange = new EventEmitter();
